...
set LIBRARY_PATHS=
set LIBRARIES= User32.lib Gdi32.lib Opengl32.lib Comdlg32.lib Ole32.lib Winmm.lib Ws2_32.lib

pushd "build"
set BUILD_MODE="debug"
set PROCESS_ASSETS="false"

set MACRO_DEFS=/DDO_SOCKETS

if %BUILD_MODE% == "release" ( 
                                                                                                                                                                                                                                                                                                                            set COMPILE_OPTIONS=%COMPILE_OPTIONS% /O2 /DDO_RELEASE_BUILD 
set EXE_NAME=Win32SocketTestingRelease.exe
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ) else ( 
set COMPILE_OPTIONS=%COMPILE_OPTIONS% /Od
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        set EXE_NAME=Win32SocketTestingDebug.exe
)
...
cl %COMPILE_OPTIONS% %MACRO_DEFS% %DEBUG_OPTIONS% %INCLUDE_PATHS% /Fe:%EXE_NAME% ..\source\win32\win32_main.cpp /link %LINK_OPTIONS% %LIBRARY_PATHS% %LIBRARIES% .\win32_resource.res
popd
